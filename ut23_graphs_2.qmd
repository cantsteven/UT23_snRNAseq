...
## DEGs and GSEA Graphs: 

I ended up creating different code chunks for graphing the DEGs and GSEA analysis for each cell type as each needed a bit of customization.

### DEGs and GSEA for Microglia
...
write.csv(yvav_kegg_df, "/stor/work/Fonken/UT23_snRNAseq/local_ut23/yvav_kegg_micro_df.csv")
...
## Inflammation Related Gene Intersections

Here I check the intersections of the DEGs for each cell type with a list of inflammation related DEGs:
...
This code chunk outputs the graphs for Figure 5
...
Here I tested graphing the percents (did not end up using this)
...
Here I am graphing the total DEGs upregulated or downregulated in each condition.
